...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h2">회원그룹 입력</h1> 
</div>

<div class="row g-5"> 
  <div class="col-md-12 col-lg-12"> 
    <form method="post" target="HiddenFrame" action="writeOk" class="needs-validation" novalidate name="form"  >
    <input type=hidden name="idUser_group" value="${userGroupVO.idUser_group }">
      <div class="row g-3">

        <div class="col-6">
          <label for="category1" class="form-label">그룹명 <span class="text-muted">(필수)</span></label>
          <input type="text" class="form-control" id="group_name" name="group_name" required minlength="1" value="${userGroupVO.group_name }">
        ...
        <div class="col-6">
          ...
          <input type="text" class="form-control" id="group_code" name="group_code" required minlength="1" value="${userGroupVO.group_code }">
          <div class="invalid-feedback">
            필수 정보입니다
          </div>
        </div>  
        ...
        <div class="col-6">
         ...
         <div class="form-check">
           	...
           	${userGroupVO.display_flag == "Y" ? "checked" : "" }>
         ...
         <div class="form-check"> 
           ...
           ${userGroupVO.display_flag == "N" ? "checked" : "" }>
        ...
        <div class="col-6">
         ...
         <div class="form-check">
           ...
           ${userGroupVO.use_flag == "Y" ? "checked" : "" }>
         ...
         <div class="form-check">
           ...
           ${userGroupVO.use_flag == "N" ? "checked" : "" }>
...
<script>
$(function(){
	var id = "${userGroupVO.idUser_group}";
	var result = "${result}";
