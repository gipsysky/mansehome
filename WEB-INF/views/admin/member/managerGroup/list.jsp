...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>  
      ...
      <div class="table-responsive">
        ...
        <table class="table table-striped table-sm border-bottom">
          ...
          <tbody> 
			<c:forEach items="${managerGroup}" var="list" varStatus="status">
				<tr>
					<td><c:out value="${ (pageMaker.total - status.index) - (pageMaker.cri.pageNum - 1) * 10 }"/></td>
					<td>
						<a class="move" href='${list.idManager_group}'>
					...
					<td>
						<a href='list/auth/${list.idManager_group}'>
							설정하기
						</a>
					</td>
				</tr>
...
<input type="hidden" name="idManager_group"> 
</form>
...
$(function(){ 
	...
	$(".move").click(function(event){
		event.preventDefault();
		document.listForm.reset();
		document.listForm.idManager_group.value = $(this).attr("href");
