...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>  
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
        <h1 class="h2">사용자 상세 노출/순서 설정 <span>${cnfVO.tbl_name } </span></h1>
...
function getList(){ 
	var url = "../view/fldWebShowDetailAjax?idTbl_cnf=${cnfVO.idTbl_cnf}&web_show_fg_detail=Y"; 
	$.get(url , function(r){
		$("#area1").html(r);
		$(".sortable").sortable({
			handle:"button",
	...
	var url = "../view/fldWebShowDetailAjax?idTbl_cnf=${cnfVO.idTbl_cnf}&web_show_fg_detail=N"; 
	$.get(url , function(r){
		$("#area2").html(r);
...
function toggleShowFg(v){
	window.open("../fldWebShowHideDetail?idTbl_cnf_fld=" + v, "HiddenFrame");	 
}

function reOrder(arr){ 
	window.open("../reOrderWebDetail?idArr="+arr+"&idTbl_cnf=${cnfVO.idTbl_cnf}", "HiddenFrame");  
}
</script>       
