...
<%@ page session="false" %>
        ...
        <div id="content" class="portfolio">
            <div class="container">
                ...
                <div class="portfolio-list" data-aos="fade-in" data-aos-delay="400">
                    <ul>
                        <li data-category="A"><a href="javascript:;" onclick="$('#portfolio18').modal({fadeDuration: 200});"><img src="/img/pf18.jpg" alt="킨텍스"></a></li>
                        <li data-category="A,S"><a href="javascript:;" onclick="$('#portfolio5').modal({fadeDuration: 200});"><img src="/img/pf5.jpg" alt="마니커몰"></a></li>
                        <li data-category="A,W"><a href="javascript:;" onclick="$('#portfolio21').modal({fadeDuration: 200});"><img src="/img/pf21.jpg" alt="오로나민C"></a></li>
                        <li data-category="A,S"><a href="javascript:;" onclick="$('#portfolio2').modal({fadeDuration: 200});"><img src="/img/pf2.jpg" alt="동아오츠카 쇼핑몰"></a></li>
                        <li data-category="S"><a href="javascript:;" onclick="$('#portfolio29').modal({fadeDuration: 200});"><img src="/img/pf29.jpg" alt="경남제약(주)"></a></li>
                        <li data-category="A"><a href="javascript:;" onclick="$('#portfolio7').modal({fadeDuration: 200});"><img src="/img/pf7.jpg" alt="스웨트마켓"></a></li>
                        <li data-category="A"><a href="javascript:;" onclick="$('#portfolio10').modal({fadeDuration: 200});"><img src="/img/pf10.jpg" alt="엔픽플"></a></li>
                        <li data-category="A,W"><a href="javascript:;" onclick="$('#portfolio17').modal({fadeDuration: 200});"><img src="/img/pf17.jpg" alt="대한사격연맹"></a></li>
                        <li data-category="A,W"><a href="javascript:;" onclick="$('#portfolio1').modal({fadeDuration: 200});"><img src="/img/pf1.jpg" alt="네스트호텔"></a></li>
                        <li data-category="W"><a href="javascript:;" onclick="$('#portfolio27').modal({fadeDuration: 200});"><img src="/img/pf27.jpg" alt="CJ엠디원"></a></li>
                        <li data-category="W"><a href="javascript:;" onclick="$('#portfolio26').modal({fadeDuration: 200});"><img src="/img/pf26.jpg" alt="말표산업주식회사"></a></li>
                        <li data-category="A,W"><a href="javascript:;" onclick="$('#portfolio4').modal({fadeDuration: 200});"><img src="/img/pf4.jpg" alt="랜드로버"></a></li>
                        <li data-category="A"><a href="javascript:;" onclick="$('#portfolio8').modal({fadeDuration: 200});"><img src="/img/pf8.jpg" alt="스쿨맘톡"></a></li>
                        <li data-category="A,S"><a href="javascript:;" onclick="$('#portfolio6').modal({fadeDuration: 200});"><img src="/img/pf6.jpg" alt="말표산업 쇼핑몰"></a></li>
                        <li data-category="S"><a href="javascript:;" onclick="$('#portfolio30').modal({fadeDuration: 200});"><img src="/img/pf30.jpg" alt="슈마커"></a></li>
                        <li data-category="A"><a href="javascript:;" onclick="$('#portfolio12').modal({fadeDuration: 200});"><img src="/img/pf12.jpg" alt="재키"></a></li>
                        <li data-category="A,W"><a href="javascript:;" onclick="$('#portfolio9').modal({fadeDuration: 200});"><img src="/img/pf9.jpg" alt="스튜디오드래곤"></a></li>
                        <li data-category="A,S"><a href="javascript:;" onclick="$('#portfolio3').modal({fadeDuration: 200});"><img src="/img/pf3.jpg" alt="라팔라코리아"></a></li>
                        <li data-category="A,W"><a href="javascript:;" onclick="$('#portfolio14').modal({fadeDuration: 200});"><img src="/img/pf14.jpg" alt="채선당"></a></li>
                        <li data-category="A,W"><a href="javascript:;" onclick="$('#portfolio15').modal({fadeDuration: 200});"><img src="/img/pf15.jpg" alt="AGCIA"></a></li>
                        <li data-category="W"><a href="javascript:;" onclick="$('#portfolio28').modal({fadeDuration: 200});"><img src="/img/pf28.jpg" alt="반려동물 복지문화센터"></a></li>
                        <li data-category="W"><a href="javascript:;" onclick="$('#portfolio25').modal({fadeDuration: 200});"><img src="/img/pf25.jpg" alt="SGI서울보증"></a></li>
                        <li data-category="A"><a href="javascript:;" onclick="$('#portfolio11').modal({fadeDuration: 200});"><img src="/img/pf11.jpg" alt="잇잡"></a></li>
                        <li data-category="A"><a href="javascript:;" onclick="$('#portfolio23').modal({fadeDuration: 200});"><img src="/img/pf23.jpg" alt="파주출판도시"></a></li>
                        <li data-category="A"><a href="javascript:;" onclick="$('#portfolio19').modal({fadeDuration: 200});"><img src="/img/pf19.jpg" alt="모아베베"></a></li>
                        <li data-category="W"><a href="javascript:;" onclick="$('#portfolio22').modal({fadeDuration: 200});"><img src="/img/pf22.jpg" alt="동아오츠카"></a></li>
                        <li data-category="S"><a href="javascript:;" onclick="$('#portfolio24').modal({fadeDuration: 200});"><img src="/img/pf24.jpg" alt="경남제약(주)"></a></li>
                        <li data-category="S"><a href="javascript:;" onclick="$('#portfolio31').modal({fadeDuration: 200});"><img src="/img/pf31.jpg" alt="트래블메이트"></a></li>
						
                    </ul>
                    <div class="btn-box">
                        <!-- 클릭할때마다 포폴이미지 4개씩 추가 -->
                        <button type="button" class="btn main line" onclick="goPortfolioList()" id="goPortfolioList" style="display: none;">MORE</button>
                        <button type="button" class="btn main line" onclick="goToTop()" id="goToTop">TOP</button>
                    </div>
                </div>
            </div>
        </div>
		...
		$(document).ready(function() {
			  ...
			  $('.portfolio-list li').removeClass('visible even').hide();

			  // 보여줄 항목 표시 및 visible 클래스 추가
			  const $visibleItems = $('.portfolio-list li').filter(function () {
				const categories = $(this).data('category');
				return categories && categories.toString().split(',').includes(filter);
			  }).addClass('visible').fadeIn();

			  // 보이는 항목 중 짝수 번째에 even 클래스 추가
		  ...
		  // 초기: APP 탭 강제 클릭 효과
		  $('.tab-nav a[data-filter="A"]').parent().addClass('active'); // 탭 active 처리
		  filterPortfolio('A'); // APP만 보여주기
		});
		</script>
        ...
        <div class="modal" id="portfolio28">
			...
			<div class="top-visual" style="background-image: url(/img/bg_pf28.png)">
				<div class="main-slide-txt">
					...
					<a href="/portfolio/portfolio.asp?fg=W"><img src="/img/v_arrow.png" alt="바로가기"></a>
				</div>
